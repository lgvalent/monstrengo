...
public class CancelarContratoServiceTestCase extends ServiceBasicTest{
	...
	public void testRun(){
		try{
			...
			String descricao = "Cancelado para testes";
			Calendar data = CalendarUtils.getCalendar();
			
			//realiza compara��es com o Banco de Dados 
			...
			service.getArgumentList().setProperty(CancelarContratoService.IN_DESCRICAO, descricao);
