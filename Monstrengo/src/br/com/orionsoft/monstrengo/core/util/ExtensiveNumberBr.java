...
public class ExtensiveNumberBr {
    ...
    *  Construtor
    *
    *@param  dec  valor BigDecimanl para colocar por extenso
    */
   public ExtensiveNumberBr(BigDecimal dec) {
      this();
      setNumber(dec);
   }
    ...
    *  Construtor 
    *
    *@param  dec  valor Double para colocar por extenso
    */
   public ExtensiveNumberBr(double dec) {
      this();
      setNumber(dec);
   }
    ...
    *  Trabalha somente com o valor absoluto do número.
    *
...
//   }
   ...
   public static String getExtenso(BigDecimal valor) {
	   return new ExtensiveNumberBr(valor).toString();    
   }
