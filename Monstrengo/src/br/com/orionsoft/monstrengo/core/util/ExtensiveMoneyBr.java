...
public class ExtensiveMoneyBr {
    ...
    *  Construtor
    *
    *@param  dec  valor BigDecimal para colocar por extenso 
    */
   public ExtensiveMoneyBr(BigDecimal dec) {
      this();
      setNumber(dec);
   }
    ...
    *  Construtor 
    *
    *@param  dec  valor Double para colocar por extenso em moeda 
    */
   public ExtensiveMoneyBr(double dec) {
      this();
      setNumber(dec);
   }
   ...
   public static String getExtenso(BigDecimal valor) {
	   return new ExtensiveMoneyBr(valor).toString();    
   }
