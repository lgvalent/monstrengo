 ...
 *
 */
@ProcessMetadata(label="Criar ou atualizar estrutura de metadados e de segurança do sistema", hint="Cria ou atualiza a estrutura de metadados e de segurança do sistema", description="Este processo permite criar novos usuários e grupos de segurança ao mesmo tempo que cria ou atualiza as estruturas de segurança e de metadados de acordo com a atual configuração de módulos da aplicação, caso a aplicação tenha sido atualizada recentemente")
