 ...
 * <p>
 * <b>Procedimento:</b><br>
 * <b>Retorna uma lista de DocumentoPagamentoBean de acordo com os critérios passados.</b>
 * 
 * @author Lucio
 * @version 20070303
 * 
 * @spring.bean id="ListarDocumentosPagamentoService" init-method="registerService"
 * @spring.property name="serviceManager" ref="ServiceManager"
 */
public class ListarDocumentosPagamentoService extends ServiceBasic {
    public static final String SERVICE_NAME = "ListarDocumentosPagamentoService";
    
    public static final String IN_CPF_CNPJ_OPT = "cpfCnpj";
    public static final String IN_DOCUMENTO_PAGAMENTO_CATEGORIA_ID_OPT = "documentoPagamentoCategoriaId";
//    public static final String IN_ITEM_CUSTO_ID_OPT = "itemCustoId";
	...
	public void execute(ServiceData serviceData) throws ServiceException {
        try {
            ...
            Long inDocumentoPagamentoCategoriaId = null;
            if (serviceData.getArgumentList().containsProperty(IN_DOCUMENTO_PAGAMENTO_CATEGORIA_ID_OPT))
            	inDocumentoPagamentoCategoriaId = (Long) serviceData.getArgumentList().getProperty(IN_DOCUMENTO_PAGAMENTO_CATEGORIA_ID_OPT);
...
//            	inItemCustoId = (Long) serviceData.getArgumentList().getProperty(IN_ITEM_CUSTO_ID_OPT);
			...
			String sqlWhere = "select " + 
			        DocumentoPagamentoBean.QUERY_SELECT +
					" from " +  DocumentoPagamento.class.getSimpleName()  + " entity where (true = true) ";
            ...
            if (inDocumentoPagamentoCategoriaId != null)
                sqlWhere += "and entity." + DocumentoPagamento.DOCUMENTO_PAGAMENTO_CATEGORIA + "= " + inDocumentoPagamentoCategoriaId + " ";
...
//                sqlWhere += "and entity. = " + in + " ";
            ...
            List<DocumentoPagamentoBean> list = serviceData.getCurrentSession().createQuery(sql).list();
    ...
    public static List<SelectItem> getTiposOrdem(){
		...
		result.add(new SelectItem(ListarDocumentosPagamentoService.ORDEM_ENDERECO, "Endereço"));
		result.add(new SelectItem(ListarDocumentosPagamentoService.ORDEM_NOME, "Nome"));
		result.add(new SelectItem(ListarDocumentosPagamentoService.ORDEM_CONTRATO, "Código do Contrato"));
		return result;
	}
