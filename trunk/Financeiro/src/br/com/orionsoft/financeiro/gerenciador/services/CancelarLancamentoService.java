...
public class CancelarLancamentoService extends ServiceBasic {
	...
	public void execute(ServiceData serviceData) throws ServiceException {
		...
		try {
			...
			/* Lucio 20150310: Evita o cancelamento de lançamento já cancelado */
			if (inLancamento.getLancamentoSituacao() != LancamentoSituacao.CANCELADO){
				...
				this.addInfoMessage(serviceData, "JA_CANCELADO");
