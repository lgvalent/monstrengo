...
<%@ taglib prefix="h" uri="http://java.sun.com/jsf/html"%>
				...
				<h:dataTable value="#{queryBean.array}" 
					...
					<h:column rendered="#{queryBean.propertiesSize > 0}" >
						...
						<h:graphicImage value="../../public/basic/img/update_d.png" title="Você não possui direitos para alterar os dados do registro" style="border:0" rendered="#{!queryBean.canUpdate}"/>
						...
						<h:graphicImage value="../../public/basic/img/delete_d.png" title="Você não possui direitos para apagar o registro" style="border:0" rendered="#{!queryBean.canDelete}"/ --%>
						...
						<f:facet name="header">
							<h:panelGroup>
								...
								<h:commandLink action="#{queryBean.doOrder}" rendered="#{!(queryBean.properties[0].name==queryBean.newOrderParam.propertyPath && queryBean.newOrderParam.orderAsc) && !(queryBean.properties[0].collection)}">
									<h:graphicImage style="border: none;" value="../../public/basic/img/order_asc.gif" alt="Ordenação crescente"/>
									<f:param name="orderProperty" value="#{queryBean.properties[0].name}" />
									<f:param name="orderDirection" value="asc"/>
								</h:commandLink>
								<h:graphicImage style="border: none;" value="../../public/basic/img/order_asc_d.gif" alt="Ordenação crescente" rendered="#{queryBean.properties[0].name==queryBean.newOrderParam.propertyPath && queryBean.newOrderParam.orderAsc}"/>
								...
								<h:commandLink action="#{queryBean.doOrder}" rendered="#{!(queryBean.properties[0].name==queryBean.newOrderParam.propertyPath && queryBean.newOrderParam.orderDesc) && !(queryBean.properties[0].collection)}">
									<h:graphicImage style="border: none;" value="../../public/basic/img/order_desc.gif" alt="Ordenação Decrescente"/>
									<f:param name="orderProperty" value="#{queryBean.properties[0].name}"/>
					...
					<h:column rendered="#{queryBean.propertiesSize > 1}" >
						<f:facet name="header">
							<h:panelGroup>
								...
								<h:graphicImage style="border: none;" value="../../public/basic/img/order_asc_d.gif" alt="Ordenação crescente" rendered="#{queryBean.properties[1].name==queryBean.newOrderParam.propertyPath && queryBean.newOrderParam.orderAsc}"/>
					...
					<h:column rendered="#{queryBean.propertiesSize > 2}" >
						<f:facet name="header">
							<h:panelGroup>
								...
								<h:graphicImage style="border: none;" value="../../public/basic/img/order_asc_d.gif" alt="Ordenação crescente" rendered="#{queryBean.properties[2].name==queryBean.newOrderParam.propertyPath && queryBean.newOrderParam.orderAsc}"/>
					...
					<h:column rendered="#{queryBean.propertiesSize > 3}" >
						<f:facet name="header">
							<h:panelGroup>
								...
								<h:graphicImage style="border: none;" value="../../public/basic/img/order_asc_d.gif" alt="Ordenação crescente" rendered="#{queryBean.properties[3].name==queryBean.newOrderParam.propertyPath && queryBean.newOrderParam.orderAsc}"/>
					...
					<h:column rendered="#{queryBean.propertiesSize > 4}" >
						<f:facet name="header">
							<h:panelGroup>
								...
								<h:graphicImage style="border: none;" value="../../public/basic/img/order_asc_d.gif" alt="Ordenação crescente" rendered="#{queryBean.properties[4].name==queryBean.newOrderParam.propertyPath && queryBean.newOrderParam.orderAsc}"/>
					...
					<h:column rendered="#{queryBean.propertiesSize > 5}" >
						<f:facet name="header">
							<h:panelGroup>
								...
								<h:graphicImage style="border: none;" value="../../public/basic/img/order_asc_d.gif" alt="Ordenação crescente" rendered="#{queryBean.properties[5].name==queryBean.newOrderParam.propertyPath && queryBean.newOrderParam.orderAsc}"/>
					...
					<h:column rendered="#{queryBean.propertiesSize > 6}" >
						<f:facet name="header">
							<h:panelGroup>
								...
								<h:graphicImage style="border: none;" value="../../public/basic/img/order_asc_d.gif" alt="Ordenação crescente" rendered="#{queryBean.properties[6].name==queryBean.newOrderParam.propertyPath && queryBean.newOrderParam.orderAsc}"/>
					...
					<h:column rendered="#{queryBean.propertiesSize > 7}" >
						<f:facet name="header">
							<h:panelGroup>
								...
								<h:graphicImage style="border: none;" value="../../public/basic/img/order_asc_d.gif" alt="Ordenação crescente" rendered="#{queryBean.properties[7].name==queryBean.newOrderParam.propertyPath && queryBean.newOrderParam.orderAsc}"/>
					...
					<h:column rendered="#{queryBean.propertiesSize > 8}" >
						<f:facet name="header">
							<h:panelGroup>
								...
								<h:graphicImage style="border: none;" value="../../public/basic/img/order_asc_d.gif" alt="Ordenação crescente" rendered="#{queryBean.properties[8].name==queryBean.newOrderParam.propertyPath && queryBean.newOrderParam.orderAsc}"/>
					...
					<h:column rendered="#{queryBean.propertiesSize > 9}" >
						<f:facet name="header">
							<h:panelGroup>
								...
								<h:graphicImage style="border: none;" value="../../public/basic/img/order_asc_d.gif" alt="Ordenação crescente" rendered="#{queryBean.properties[9].name==queryBean.newOrderParam.propertyPath && queryBean.newOrderParam.orderAsc}"/>
