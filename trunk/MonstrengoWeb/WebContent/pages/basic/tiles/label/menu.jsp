...
<h:form id="formMensalidade" style="text-align:left;">
	<h:panelGrid columns="7" >
		 ...
		 <h:graphicImage value="../basic/img/create_d.png" title="Você não possui direitos para criar um novo registro" style="border:0" rendered="#{!menuBean.crudMap.AddressLabel.canCreate}" />
		...
		<h:graphicImage value="../basic/img/query_d.png" title="Você não possui direitos para visualizar esta entidade" style="border:0" rendered="#{!menuBean.crudMap.AddressLabel.canRetrieve}" />
	...
	<h:panelGrid columns="7" >
		 ...
		 <h:graphicImage value="../basic/img/create_d.png" title="Você não possui direitos para criar um novo registro" style="border:0" rendered="#{!menuBean.crudMap.AddressLabelGroup.canCreate}" />
		...
		<h:graphicImage value="../basic/img/query_d.png" title="Você não possui direitos para visualizar esta entidade" style="border:0" rendered="#{!menuBean.crudMap.AddressLabelGroup.canRetrieve}" />
	...
	<h:panelGrid columns="7" >
		 ...
		 <h:graphicImage value="../basic/img/create_d.png" title="Você não possui direitos para criar um novo registro" style="border:0" rendered="#{!menuBean.crudMap.ModelLabel.canCreate}" />
		...
		<h:graphicImage value="../basic/img/query_d.png" title="Você não possui direitos para visualizar esta entidade" style="border:0" rendered="#{!menuBean.crudMap.ModelLabel.canRetrieve}" />
	...
	<h:panelGrid columns="7" >
		 ...
		 <h:graphicImage value="../basic/img/create_d.png" title="Você não possui direitos para criar um novo registro" style="border:0" rendered="#{!menuBean.crudMap.ModelLabelEntity.canCreate}" />
		...
		<h:graphicImage value="../basic/img/query_d.png" title="Você não possui direitos para visualizar esta entidade" style="border:0" rendered="#{!menuBean.crudMap.ModelLabelEntity.canRetrieve}" />
