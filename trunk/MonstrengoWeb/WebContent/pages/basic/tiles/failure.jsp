...
<f:subview id="failure">
	<h:dataTable 
			value="#{messagesBean.fromSecondMessage}" 
			var='msg'
			style="color:blue">
		<h:column>
			<f:facet name="header">
				<h:panelGrid style="text-align:center;">
					<h:graphicImage value="../basic/img/alert.png" style="border:0" />
					<h:outputText value="Mensagens adicionais:"/>
				</h:panelGrid>
			</f:facet>

			<h:outputText value="#{msg.summary}" title="#{msg.detail}" escape="false"/>
		</h:column>
	</h:dataTable>
	...
	<h:panelGrid rendered="false">
		<h:messages layout="table" showSummary="false" showDetail="true" id="failure" tooltip="true"/>
	</h:panelGrid>
		<%-- 
		<f:verbatim>
	...
	<h:panelGrid columns="3">
		<h:outputLink value="javascript:history.back()">
			<h:panelGrid style="text-align:center;">
				<h:graphicImage value="../basic/img/voltar.png" title="Voltar"
					style="border:0" />
		...
		<h:outputLink value="javascript:window.print()">
			<h:panelGrid style="text-align:center;">
				<h:graphicImage value="../basic/img/printer.png" title="Imprimir"
					style="border:0" />
		...
		<h:outputLink value="javascript:window.close()">
			<h:panelGrid style="text-align:center;">
				<h:graphicImage value="../basic/img/close_b.png"
