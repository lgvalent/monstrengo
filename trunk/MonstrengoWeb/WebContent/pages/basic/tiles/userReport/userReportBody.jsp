  ...
  <h:form target="_blank">
	<h:dataTable value="#{listUserReportBean.userReports.list}"
		...
		<h:column>
			...
			<h:graphicImage styleClass="noprint" value="../basic/img/update_d.png" title="Você não possui direitos para alterar os dados do registro" style="border:0" rendered="#{!menuBean.crudMap[item.info.type.simpleName].canUpdate}"/>
			...
			<h:graphicImage styleClass="noprint" value="../basic/img/delete_d.png" title="Você não possui direitos para apagar o registro" style="border:0" rendered="#{!menuBean.crudMap[item.info.type.simpleName].canDelete}"/>
