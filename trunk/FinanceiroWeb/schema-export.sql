create table auditorship_crud (id bigint not null auto_increment, description varchar(255), ocurrencyDate datetime, terminal varchar(255), created bit, deleted bit, entityId bigint, updated bit, applicationEntity bigint, applicationUser bigint, primary key (id)) ENGINE=InnoDB
...
create table auditorship_service (id bigint not null auto_increment, description varchar(255), ocurrencyDate datetime, terminal varchar(255), serviceName varchar(50), applicationUser bigint, primary key (id)) ENGINE=InnoDB
create table basic_adesao_contrato (discriminator varchar(3) not null, id bigint not null auto_increment, codigo varchar(20), dataAdesao datetime, dataRemocao datetime, inativo bit, observacoes bigint, pessoa bigint, contrato_id bigint, primary key (id)) ENGINE=InnoDB
...
create table basic_contador (id bigint not null auto_increment, crc varchar(10), dataCadastro datetime, escritorioContabil bigint, fisica bigint, observacoes bigint, primary key (id)) ENGINE=InnoDB
...
create table basic_contrato_contato (id bigint not null auto_increment, dataHora datetime, dataRetorno datetime, observacoes varchar(255), retornado bit, retornoCliente bit, contatoRetorno bigint, motivo bigint, representante bigint, contrato bigint, primary key (id)) ENGINE=InnoDB
...
create table basic_endereco (id bigint not null auto_increment, caixaPostal varchar(20), cep varchar(8), complemento varchar(50), numero integer, municipio bigint, bairro bigint, logradouro bigint, enderecoCategoria bigint, pessoa bigint, primary key (id)) ENGINE=InnoDB
...
create table basic_funcionario (id bigint not null auto_increment, dataAdmissao datetime, dataDemissao datetime, fisica bigint, juridica bigint, cargo bigint, primary key (id)) ENGINE=InnoDB
...
create table basic_socio (id bigint not null auto_increment, dataEntrada datetime, dataSaida datetime, cargo bigint, fisica bigint, juridica bigint, primary key (id)) ENGINE=InnoDB
create table basic_telefone (id bigint not null auto_increment, ddd varchar(4), numero varchar(8), ramal varchar(5), pessoa_id bigint, telefoneOperadora bigint, tipoTelefone bigint, primary key (id)) ENGINE=InnoDB
...
create table financeiro_contrato_descontos_acrescimos (id bigint not null auto_increment, dataFinal date, dataInicial date, ordem integer, percentual numeric(19,2), valor numeric(19,2), classificacaoContabil bigint, contratoFinanceiro bigint, itemCusto bigint, primary key (id)) ENGINE=InnoDB
create table financeiro_convenio_cobranca (discriminator varchar(3) not null, id bigint not null auto_increment, diasAntecipacao integer, nome varchar(50), nomeGerenciadorDocumento varchar(50), observacoes varchar(256), remessaNumeroSequencial integer, remessaUltimaData datetime, sequenciaNumeroDocumento bigint, aceite bit, bancoGeraOcorrenciaValorTarifa bit, cancelado bit, canceladoData datetime, carteiraCodigo varchar(2), carteiraVariacao varchar(3), cedenteCodigo varchar(7), cedenteDigito varchar(1), layoutCnab varchar(10), localPagamento varchar(80), nossoNumeroAno integer, valorTarifa numeric(19,2), contratante bigint, contratado bigint, centroCustoGeral bigint, documentoPagamentoCategoria bigint, itemCustoTarifa bigint, itemCustoIof bigint, contaBancaria bigint, primary key (id)) ENGINE=InnoDB
create table financeiro_convenio_pagamento (discriminator varchar(3) not null, id bigint not null auto_increment, nome varchar(50), nomeGerenciadorDocumento varchar(50), observacoes varchar(256), proximoNumeroCheque bigint, contratante bigint, contaBancaria bigint, chequeModelo bigint, contratado bigint, primary key (id)) ENGINE=InnoDB
create table financeiro_documento_cobranca (discriminator varchar(3) not null, id bigint not null auto_increment, data date, dataCancelamento date, dataImpressao datetime, dataVencimento date, instrucoes3 varchar(80), layoutId integer, numeroDocumento varchar(20), transacao integer, valor numeric(19,2), valorAcrescimo numeric(19,2), valorDesconto numeric(19,2), valorJuros numeric(19,2), valorMulta numeric(19,2), valorPago numeric(19,2), dataCredito datetime, dataUltimaOcorrencia datetime, outrasDeducoes numeric(19,2), valorIOF numeric(19,2), valorTarifa numeric(19,2), convenioCobranca bigint, ultimaOcorrencia bigint, contrato bigint, documentoCobrancaCategoria bigint, primary key (id)) ENGINE=InnoDB
...
create table financeiro_documento_pagamento (discriminator varchar(3) not null, id bigint not null auto_increment, data datetime, dataCancelamento datetime, dataImpressao datetime, dataVencimento datetime, layoutId integer, numeroDocumento varchar(20), transacao integer, valor numeric(19,2), agencia varchar(4), contaCorrente varchar(8), contaCorrenteDigito varchar(2), banco bigint, documentoPagamentoCategoria bigint, convenioPagamento bigint, contrato bigint, primary key (id)) ENGINE=InnoDB
create table financeiro_documento_pagamento_categoria (id bigint not null auto_increment, layoutId integer, nome varchar(50), contaPadrao bigint, convenioPagamento bigint, primary key (id)) ENGINE=InnoDB
...
create table financeiro_lancamento (discriminator varchar(3) not null, id bigint not null auto_increment, codigoExterno varchar(20), data date, dataVencimento date, descricao varchar(256), lancamentoSituacao varchar(10), naoReceberAposVencimento bit, saldo numeric(19,2), valor numeric(19,2), frequencia varchar(20), quantidadeRestante integer, agendamentoItem bigint, contrato bigint, documentoCobranca bigint, ultimoLancamento bigint, documentoPagamento bigint, operacao bigint, contaPrevista bigint, primary key (id)) ENGINE=InnoDB
create table financeiro_lancamento_item (discriminator varchar(3) not null, id bigint not null auto_increment, dataCompetencia date, dataLancamento date, descricao varchar(256), peso numeric(19,2), valor numeric(19,2), centroCusto bigint, contrato bigint, itemCusto bigint, adesaoContrato bigint, classificacaoContabil bigint, lancamento bigint, primary key (id)) ENGINE=InnoDB
create table financeiro_lancamento_movimento (id bigint not null auto_increment, acrescimo numeric(19,2), data date, dataCompensacao date, dataLancamento date, desconto numeric(19,2), descricao varchar(256), estornado bit, juros numeric(19,2), lancamentoMovimentoCategoria varchar(20), multa numeric(19,2), valor numeric(19,2), valorTotal numeric(19,2), documentoPagamento bigint, lancamento bigint, transferencia bigint, conta bigint, primary key (id)) ENGINE=InnoDB
create table financeiro_lancamento_parcela (id bigint not null auto_increment, dataLancamento date, dataVencimento date, numero integer, valor numeric(19,2), lancamentoMovimento bigint, documentoCobranca bigint, lancamento bigint, primary key (id)) ENGINE=InnoDB
...
create table security_right_crud (id bigint not null auto_increment, createAllowed bit, deleteAllowed bit, retrieveAllowed bit, updateAllowed bit, securityGroup bigint, applicationEntity bigint, primary key (id)) ENGINE=InnoDB
