...
import br.com.orionsoft.financeiro.documento.pagamento.processes.AlterarDocumentoPagamentoProcess;
...
/**
 * Bean que controla a view para alterar o documento de pagamento previsto 
 * para o lançamento.
 * @author Lucio 20120430
 */
@ManagedBean
@SessionScoped
public class AlterarDocumentoPagamentoBean extends BeanSessionBasic implements IRunnableProcessView{
	private static final long serialVersionUID = 1L;

	public static String URL_PARAM_LANCAMENTO_ID = "lancamentoId";
	
	/** Define a view JSF que é ativada para cada view */
	public static final String VIEW_NAME = "alterarDocumentoPagamentoBean";
    public static final String FACES_VIEW_PASSO_1 = "/pages/financeiro/gerenciadorAlterarDocumentoPagamento1?faces-redirect=true";
    public static final String FACES_VIEW_PASSO_2 = "/pages/financeiro/gerenciadorAlterarDocumentoPagamento2?faces-redirect=true";
    public static final String FACES_VIEW_PASSO_3 = "/pages/financeiro/gerenciadorAlterarDocumentoPagamento3?faces-redirect=true";

	private AlterarDocumentoPagamentoProcess process = null;
    ...
    public AlterarDocumentoPagamentoProcess getProcess() throws ProcessException {
        if (process == null)
            process = (AlterarDocumentoPagamentoProcess)this.getApplicationBean().getProcessManager().createProcessByName(AlterarDocumentoPagamentoProcess.PROCESS_NAME, this.getUserSessionBean().getUserSession());
        return process;
    }

    public String doConfirmar() throws ParseException {
        log.debug("AlterarDocumentoPagamentoBean.doConfirmar");
    ...
    public String doVisualizar() throws BusinessException{
       log.debug("MudarDocumentoPagamentoBean.doVisulizar");
    ...
    public String actionAlterarDocumento(long lancamentoId){
        log.debug("AlterarDocumentoPagamentoBean.actionAlterarDocumento");
	...
	public String getRunnableEntityProcessName() {
		return AlterarDocumentoPagamentoProcess.PROCESS_NAME;
	}
