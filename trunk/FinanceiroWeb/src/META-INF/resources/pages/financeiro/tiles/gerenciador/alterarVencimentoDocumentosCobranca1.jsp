...
<h:form id="form" >
	...
	<h:panelGrid columns="3" cellpadding="1" style="font: 12px">
		...
		<h:inputText id="data" value="#{alterarVencimentoDocumentosCobrancaBean.process.data.time}" size="10" maxlength="10" onblur="return onblurCalendar(this, 'dd/MM/yyyy')" required="true">
		...
		<h:panelGroup>
			...
			<h:commandButton value="Confirmar" action="#{alterarVencimentoDocumentosCobrancaBean.actionAlterar}"/>
		</h:panelGroup>
		<h:outputLabel value=""/>
		<h:outputLabel value=""/>
	</h:panelGrid>
