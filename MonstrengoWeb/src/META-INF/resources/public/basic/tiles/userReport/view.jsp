...
<%--				
				...
				<h:graphicImage value="../../public/basic/img/retrieve_d.png" title="Você não possui direitos para visualizar os dados do registro" style="border:0" rendered="#{!menuBean.crudMap.EtiquetaModelo.canRetrieve}"/>
				...
				<h:graphicImage value="../../public/basic/img/update_d.png" title="Você não possui direitos para alterar os dados do registro" style="border:0" rendered="#{!menuBean.crudMap.EtiquetaModelo.canUpdate}"/>
				...
				<h:graphicImage value="../../public/basic/img/delete_d.png" title="Você não possui direitos para apagar o registro" style="border:0" rendered="#{!menuBean.crudMap.EtiquetaModelo.canDelete}"/>
				...
				<h:outputLink value="javascript:linkCreatePopup('#{menuBean.infoMap.EtiquetaModelo.type.name}')" rendered="#{menuBean.crudMap.EtiquetaModelo.canCreate}">
   					<h:graphicImage value="../../public/basic/img/create.png" title="Cria um novo registro de #{menuBean.infoMap.EtiquetaModelo.label}." style="border:0"/>
				</h:outputLink>
				<h:graphicImage value="../../public/basic/img/create_d.png" title="Você não possui direitos para criar um novo registro de #{menuBean.infoMap.EtiquetaModelo.label}" style="border:0" rendered="#{!menuBean.crudMap.EtiquetaModelo.canCreate}"/>
--%>
			</h:panelGroup>
