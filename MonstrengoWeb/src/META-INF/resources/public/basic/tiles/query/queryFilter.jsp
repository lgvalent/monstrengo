...
<h:panelGrid >
	...
	<h:panelGrid columns="2">
	  ...
	  <h:panelGrid columns="1">
		...
		<h:panelGroup rendered="#{!queryBean.canCreate && !queryBean.info.hasSubEntities}">
			<h:graphicImage styleClass="noprint" value="../../public/basic/img/create_d.png" title="Você não possui direitos para criar um novo registro de #{queryBean.info.label}" style="border:0" />
			<h:outputText value="#{queryBean.info.label}" />
		</h:panelGroup>
	    <h:dataTable
	        styleClass="noprint"
			...
			<h:column>
				<h:commandLink action="#{createBean.actionCreate}"  rendered="#{item.canCreate}" style="font-size: smaller;">
		    		<h:graphicImage value="../../public/basic/img/create.png" title="Clique aqui para criar um novo registro de #{item.label}" style="border:0" />
				...
				<h:graphicImage value="../../public/basic/img/create_d.png" title="Você não possui direitos para criar um novo registro de #{item.label}" style="border:0" rendered="#{!item.canCreate}"/>
			</h:column>
	    </h:dataTable>
	  </h:panelGrid>
	</h:panelGrid>
	...
	<h:panelGrid columns="5" styleClass="noprint">
 	  <h:panelGroup style="text-align: right; color: #006600; font-size: smaller;">
		...
		<h:graphicImage value="../../public/basic/img/advanced_query.png" style="border:0" width="16" height="16"/>
	  ...
	  <h:panelGroup style="text-align: right; color: #0000FF; font-size: smaller;">
		...
		<h:graphicImage value="../../public/basic/img/advanced_sort.png" style="border:0" width="16" height="16"/>
	  ...
	  <h:panelGroup style="text-align: right; color: #EE2C2C; font-size: smaller;">
		...
		<h:graphicImage value="../../public/basic/img/advanced_report.png" style="border:0" width="16" height="16"/>
	  ...
	  <h:panelGroup style="text-align: right; color: #FF751A; font-size: smaller;">
		...
		<h:graphicImage value="../../public/basic/img/advanced_user_report.png" style="border:0" width="16" height="16"/>
