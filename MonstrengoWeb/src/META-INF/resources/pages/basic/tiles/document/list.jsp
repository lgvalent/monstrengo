...
<h:graphicImage value="../basic/img/create_d.png" title="Você não possui direitos para criar um novo registro" style="border:0" rendered="#{!menuBean.crudMap.ModelDocumentEntity.canCreate}" /--%>
		...
		<h:column>
			<f:facet name="header">
				...
				<h:commandLink action="#{documentEntityBean.actionPreview}" rendered="#{menuBean.crudMap[item.info.type.simpleName].canRetrieve}">
					<h:graphicImage value="../basic/img/preview.png" style="border:0" width="16" height="16"title="Previsualiza o documento"/>
				...
				<h:graphicImage value="../basic/img/update_d.png" title="Você não possui direitos para alterar os dados do registro" style="border:0" rendered="#{!menuBean.crudMap[item.info.type.simpleName].canUpdate}"/>
				...
				<h:graphicImage value="../basic/img/delete_d.png" title="Você não possui direitos para apagar o registro" style="border:0" rendered="#{!menuBean.crudMap[item.info.type.simpleName].canDelete}"/>
				...
				<h:commandLink action="#{documentEntityBean.actionCompile}" rendered="#{item.propertiesMap.applicationEntity.value.valueNull and menuBean.processMap.CompileDocumentProcess}" >
					<h:graphicImage value="../basic/img/run_task.png" style="border:0" width="16" height="16"title="Gera o documento que n�o precisa de entidade"/>
