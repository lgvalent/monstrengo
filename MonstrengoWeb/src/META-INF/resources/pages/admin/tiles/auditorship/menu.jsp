	...
	<h:panelGrid >
	      ...
	      <h:panelGrid columns="3" >
			 <h:outputLink value="javascript:linkQueryFilter('#{menuBean.infoMap.AuditCrudRegister.name}', '')" rendered="#{menuBean.crudMap.AuditCrudRegister.canRetrieve}">
 			 ...
 			 <h:graphicImage value="../../public/basic/img/query_d.png" title="Você não possui direitos para visualizar esta entidade" style="border:0" rendered="#{!menuBean.crudMap.AuditCrudRegister.canRetrieve}" />
	      ...
	      <h:panelGrid columns="3" >
			 <h:outputLink value="javascript:linkQueryFilter('#{menuBean.infoMap.AuditProcessRegister.name}','')" rendered="#{menuBean.crudMap.AuditProcessRegister.canRetrieve}">
 			 ...
 			 <h:graphicImage value="../../public/basic/img/query_d.png" title="Você não possui direitos para visualizar esta entidade" style="border:0" rendered="#{!menuBean.crudMap.AuditProcessRegister.canRetrieve}" />
	      ...
	      <h:panelGrid columns="3" >
			 <h:outputLink value="javascript:linkQueryFilter('#{menuBean.infoMap.AuditServiceRegister.name}','')" rendered="#{menuBean.crudMap.AuditServiceRegister.canRetrieve}">
 			 ...
 			 <h:graphicImage value="../../public/basic/img/query_d.png" title="Você não possui direitos para visualizar esta entidade" style="border:0" rendered="#{!menuBean.crudMap.AuditServiceRegister.canRetrieve}" />
