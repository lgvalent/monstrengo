...
<f:subview id="menu_principal">
  <h:form>
	...
	<h:outputLink value="javascript:popupPageName('../basic/menu.jsp',450,600,'CADASTRO')">	
    	<h:graphicImage value="../../public/basic/img/menu_cadastro.png" title="Cadastro" style="border:0"/>
		<f:verbatim><br></f:verbatim>
	...
	<h:outputLink value="javascript:popupPageName('../administracao/menu.jsp',600,500, 'ADMINISTRACAO')">	
    	<h:graphicImage value="../admin/img/menu.png" title="Administração" style="border:0"/>
		<f:verbatim><br></f:verbatim>
	...
	<h:panelGrid>
		...
		<h:outputLink value="javascript:popupPage('../basic/listUserReport.jsp',0,0)">
			<h:graphicImage value="../../public/basic/img/run_task.png" style="border:0" width="16" height="16"/>	
