...
<h:panelGrid>
  ...
  <f:verbatim>
    ...
    <h:panelGrid columns="7" style="font-size: small">
		 ...
		 <h:graphicImage value="../basic/img/create_d.png" title="Você não possui direitos para criar um novo registro" style="border:0" rendered="#{!menuBean.crudMap.Agendamento.canCreate}" />
		 <h:outputText value=" " />
		 <h:outputLink value="javascript:linkQueryFilter('#{menuBean.infoMap.Agendamento.name}','')" rendered="#{menuBean.crudMap.Agendamento.canRetrieve}">
 		 ...
 		 <h:graphicImage value="../basic/img/query_d.png" title="Você não possui direitos para visualizar esta entidade" style="border:0" rendered="#{!menuBean.crudMap.Agendamento.canRetrieve}" />
	...
	<h:panelGrid columns="7" style="font-size: small">
		 ...
		 <h:graphicImage value="../basic/img/create_d.png" title="Você não possui direitos para criar um novo registro" style="border:0" rendered="#{!menuBean.crudMap.ContratoFinanceiro.canCreate}" />
		 <h:outputText value=" " />
		 <h:outputLink value="javascript:linkQueryFilter('#{menuBean.infoMap.ContratoFinanceiro.name}','')" rendered="#{menuBean.crudMap.ContratoFinanceiro.canRetrieve}">
 		 ...
 		 <h:graphicImage value="../basic/img/query_d.png" title="Você não possui direitos para visualizar esta entidade" style="border:0" rendered="#{!menuBean.crudMap.ContratoFinanceiro.canRetrieve}" />
    ...
    <h:panelGrid columns="7" style="font-size: small" >
		 ...
		 <h:graphicImage value="../basic/img/create_d.png" title="Você não possui direitos para criar um novo registro" style="border:0" rendered="#{!menuBean.crudMap.ContratoFinanceiroCategoria.canCreate}" />
		 <h:outputText value=" " />
		 <h:outputLink value="javascript:linkQueryFilter('#{menuBean.infoMap.ContratoFinanceiroCategoria.name}','')" rendered="#{menuBean.crudMap.ContratoFinanceiroCategoria.canRetrieve}">
 		 ...
 		 <h:graphicImage value="../basic/img/query_d.png" title="Você não possui direitos para visualizar esta entidade" style="border:0" rendered="#{!menuBean.crudMap.ContratoFinanceiroCategoria.canRetrieve}" />
    ...
    <%--h:panelGrid columns="7" >
		 ...
		 <h:graphicImage value="../basic/img/create_d.png" title="Você não possui direitos para criar um novo registro" style="border:0" rendered="#{!menuBean.crudMap.Documento.canCreate}" />
		 <h:outputText value=" " />
		 <h:outputLink value="javascript:linkQueryFilter('#{menuBean.infoMap.Documento.name}','')" rendered="#{menuBean.crudMap.Documento.canRetrieve}">
 		 ...
 		 <h:graphicImage value="../basic/img/query_d.png" title="Você não possui direitos para visualizar esta entidade" style="border:0" rendered="#{!menuBean.crudMap.Documento.canRetrieve}" />
    ...
    <h:panelGrid columns="7" style="font-size: small" >
		 ...
		 <h:graphicImage value="../basic/img/create_d.png" title="Você não possui direitos para criar um novo registro" style="border:0" rendered="#{!menuBean.crudMap.CentroCusto.canCreate}" />
		 <h:outputText value=" " />
		 <h:outputLink value="javascript:linkQueryFilter('#{menuBean.infoMap.CentroCusto.name}','')" rendered="#{menuBean.crudMap.CentroCusto.canRetrieve}">
 		 ...
 		 <h:graphicImage value="../basic/img/query_d.png" title="Você não possui direitos para visualizar esta entidade" style="border:0" rendered="#{!menuBean.crudMap.CentroCusto.canRetrieve}" />
    ...
    <h:panelGrid columns="7" style="font-size: small" >
		 ...
		 <h:graphicImage value="../basic/img/create_d.png" title="Você não possui direitos para criar um novo registro" style="border:0" rendered="#{!menuBean.crudMap.Conta.canCreate}" />
		 <h:outputText value=" " />
		 <h:outputLink value="javascript:linkQueryFilter('#{menuBean.infoMap.Conta.name}','')" rendered="#{menuBean.crudMap.Conta.canRetrieve}">
		 	<h:graphicImage value="../basic/img/query.png" title="Pesquisar" style="border:0" />
		 </h:outputLink>
 		 <h:graphicImage value="../basic/img/query_d.png" title="Você não possui direitos para visualizar esta entidade" style="border:0" rendered="#{!menuBean.crudMap.Conta.canRetrieve}" />
	...
	<h:panelGrid columns="7" style="font-size: small" >
		 ...
		 <h:graphicImage value="../basic/img/create_d.png" title="Você não possui direitos para criar um novo registro" style="border:0" rendered="#{!menuBean.crudMap.ItemCusto.canCreate}" />
		 <h:outputText value=" " />
		 <h:outputLink value="javascript:linkQueryFilter('#{menuBean.infoMap.ItemCusto.name}','')" rendered="#{menuBean.crudMap.ItemCusto.canRetrieve}">
 		 ...
 		 <h:graphicImage value="../basic/img/query_d.png" title="Você não possui direitos para visualizar esta entidade" style="border:0" rendered="#{!menuBean.crudMap.ItemCusto.canRetrieve}" />
	...
	<h:panelGrid columns="7" style="font-size: small" >
		 ...
		 <h:graphicImage value="../basic/img/create_d.png" title="Você não possui direitos para criar um novo registro" style="border:0" rendered="#{!menuBean.crudMap.Lancamento.canCreate}" />
		 <h:outputText value=" " />
		 <h:outputLink value="javascript:linkQueryFilter('#{menuBean.infoMap.Lancamento.name}','')" rendered="#{menuBean.crudMap.Lancamento.canRetrieve}">
 		 ...
 		 <h:graphicImage value="../basic/img/query_d.png" title="Você não possui direitos para visualizar esta entidade" style="border:0" rendered="#{!menuBean.crudMap.Lancamento.canRetrieve}" />
    ...
    <h:panelGrid columns="7" style="font-size: small" >
		 ...
		 <h:graphicImage value="../basic/img/create_d.png" title="Você não possui direitos para criar um novo registro" style="border:0" rendered="#{!menuBean.crudMap.LancamentoMovimento.canCreate}" />
		 <h:outputText value=" " />
		 <h:outputLink value="javascript:linkQueryFilter('#{menuBean.infoMap.LancamentoMovimento.name}','')" rendered="#{menuBean.crudMap.LancamentoMovimento.canRetrieve}">
 		 ...
 		 <h:graphicImage value="../basic/img/query_d.png" title="Você não possui direitos para visualizar esta entidade" style="border:0" rendered="#{!menuBean.crudMap.LancamentoMovimento.canRetrieve}" />
